...
import { FileText, Lock, Mail, ArrowRight, UserCheck } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 sm:p-6">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-slate-500">Collaborative document workspace</p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200/80 shadow-elevated p-6 sm:p-8 space-y-6">
          <div className="space-y-1">
            ...
            <p className="text-xs text-slate-500">Enter your credentials to access your documents</p>
          </div>
          ...
          <div className="pt-4 border-t border-slate-100 space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className="p-2 bg-slate-50 hover:bg-brand-50 hover:border-brand-200 border border-slate-200 rounded-xl text-xs text-left transition flex items-center space-x-2"
              >
                <UserCheck className="w-4 h-4 text-brand-600 flex-shrink-0" />
                <div className="min-w-0">
                  <p className="font-semibold text-slate-800 truncate">Alice</p>
                  <p className="text-[10px] text-slate-400 truncate">alice@example.com</p>
                </div>
              </button>
              ...
              >
                <UserCheck className="w-4 h-4 text-brand-600 flex-shrink-0" />
                <div className="min-w-0">
                  <p className="font-semibold text-slate-800 truncate">Bob</p>
                  <p className="text-[10px] text-slate-400 truncate">bob@example.com</p>
                </div>
              </button>
            </div>
          </div>
